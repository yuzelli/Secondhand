...
import com.example.yuzelli.secondhand.adapter.GuideViewAdapter;
    ...
    private void initoper() {
        ...
        tv_immediatelyEnter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                SharedPreferences.Editor editor = getSharedPreferences(ConstantsUtils.FIRST_LOGIN_SP,MODE_PRIVATE).edit();
                editor.putBoolean(ConstantsUtils.FIRST_LOGIN_KEY, false);
                editor.commit();
